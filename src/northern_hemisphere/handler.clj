...
(enlive/deftemplate szm-template "public/zhongmou/index.html" []
                    append-resources)
...
(defroutes public-routes
           ...
           (handler/site (route/resources "/zhongmou/javascript" {:root "public/zhongmou/javascript"}))
           (handler/site (route/resources "/zhongmou/partials" {:root "public/zhongmou/partials"}))
